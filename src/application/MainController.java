...
public class MainController {
    ...
    @FXML
    private Button returnButton, saveButton, loadButton;
    @FXML
    ...
    private void browseButton(ActionEvent event) {
        ...
        fc.setInitialDirectory(new File("C:\\Users\\as083\\Desktop\\Jinyuchen\\CA2photo"));
